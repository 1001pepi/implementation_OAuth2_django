...
class ImageViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request):
        ...
        new_image = Image.objects.create(name=request.data['name'], owner=User.objects.get(id=request.data['owner_id']), image=request.data['image'])
